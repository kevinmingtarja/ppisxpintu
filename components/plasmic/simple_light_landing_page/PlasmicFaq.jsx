...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: BtVnlZOk39LgvY/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ontJp)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__q9Ojg)}>
          <div className={classNames(projectcss.all, sty.freeBox__ohc23)}>
            {p.renderPlasmicSlot({
