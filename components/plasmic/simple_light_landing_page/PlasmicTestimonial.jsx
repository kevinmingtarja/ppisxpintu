...
import Avatar from "../../Avatar"; // plasmic-import: mSAMIIjmOTBMVb/component
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__coQso)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__b9Lr7)}
        >
          <div
            className={classNames(
              projectcss.all,
