...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: I998XhvLi8pnj-/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__sPiYy, {
          [sty.freeBoxlong__sPiYyjGflc]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__t89Zn, {
            [sty.freeBoxlong__t89ZNjGflc]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__mVt6U)}
                role={"img"}
              />
            ),
